...
def personal_sum(numbers: List[Any]) -> Tuple[int, int]:
    result = 0
    incorrect_data = 0
...
def calculate_average(numbers: Union[List[Any], Any]) -> Optional[float]:
    try:
        result, incorrect_data = personal_sum(numbers)  # type: ignore
